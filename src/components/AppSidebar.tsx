...
const teacherLinks = [
  ...
  { to: '/redacao/elite', icon: ScanEye, label: '🧠 Super IA de Elite', section: '🏫 Sala de Aula' },
  ...
  { to: '/vestibulares', icon: Landmark, label: 'Vestibulares & Seleções', section: '📊 Avaliação' },
  { to: '/tecnicos', icon: Cpu, label: 'Técnicos & Institutos', section: '📊 Avaliação' },
  ...
  { to: '/questoes', icon: BookOpen, label: 'Banco de Questões', section: '📊 Avaliação' },
  ...
  { to: '/provas', icon: FileText, label: 'Minhas Provas', section: '📁 Biblioteca' },
  { to: '/minha-biblioteca', icon: Library, label: 'Minha Biblioteca', section: '📁 Biblioteca' },
  { to: '/biblioteca', icon: Library, label: 'Biblioteca de Avaliações', section: '📁 Biblioteca' },
  { to: '/disciplinas', icon: Layers, label: 'Disciplinas', section: '📁 Biblioteca' },
