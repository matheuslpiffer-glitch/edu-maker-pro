...
import SimulatorConcursoPanel from '@/components/SimulatorConcursoPanel';
          ...
          <TabsContent value="create">
            <div className="flex flex-col xl:flex-row gap-6">
              ...
              <div className="w-full xl:w-[600px] xl:shrink-0 space-y-6">
                ...
                {isInclusao && (
                  <SimulatorInclusaoPanel
                    aeeMode={aeeMode}
                    setAeeMode={setAeeMode}
                    aeeTopic={aeeTopic}
                    setAeeTopic={setAeeTopic}
                    aeeQuestionCount={aeeQuestionCount}
                    setAeeQuestionCount={setAeeQuestionCount}
                    aeeQuestionType={aeeQuestionType}
                    setAeeQuestionType={setAeeQuestionType}
                    aeeContent={aeeContent}
                    setAeeContent={setAeeContent}
                    generating={generating}
                    onGenerate={async () => {
                      setGenerating(true);
                      setQuestions([]);
