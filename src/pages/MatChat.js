...
export default function MatChat() {
    ...
    return (<div className="flex flex-col h-[calc(100vh-4rem)] min-h-0 bg-white">
      <header className="flex flex-col border-b border-slate-100 bg-white">
        <div className="flex items-center justify-between gap-4 px-4 sm:px-8 py-4">
          ...
          <button onClick={() => { resetRef.current?.(); setResetKey(k => k + 1); }} className="flex items-center gap-2 px-3 py-2 rounded-lg text-slate-500 hover:text-slate-800 hover:bg-slate-50 transition-colors text-xs font-semibold">
        ...
        <div className="flex flex-wrap items-center gap-3 px-4 sm:px-8 pb-4">
          <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 shadow-sm">
            ...
            <select className="bg-transparent text-xs font-bold text-slate-600 focus:outline-none cursor-pointer" defaultValue="Anos Finais">
          ...
          <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 shadow-sm">
            ...
            <select className="bg-transparent text-xs font-bold text-slate-600 focus:outline-none cursor-pointer" defaultValue="Plano de Aula">
